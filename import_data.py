...
for itemid in jsonitems:
    ...
    fields = ['accuracy', 'attack', 'attack_speed', 'auto_gather', 'autoMine', 'auto_refiine', 'auto_scavenge',
              'defense', 'description ', 'droprate', 'evasion', 'experience', 'gear_type', 'health', 'loot_luck',
              'minimum_mining_level', 'mining_luck', 'perception', 'planet_limit', 'regeneration', 'resilience',
              'scavenge_luck', 'ship_speed', 'storagelimit', 'strength', 'value']
        ...
        for material in planetjson['loot']:
            ...
            if dbmaterial.first():
                ...
                if loot.first():
                    ...
                    db.session.add(PlanetLoot(planet_id=newplanet.id, item_id=dbmaterial.id,
...
for playerid in jsonplayers:
    ...
    fields = ['created', 'last_login', 'access_level', 'last_mine', 'last_scavenge', 'last_gather', 'planet_id']
